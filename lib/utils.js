...
export const liftTypes = [
  ...
  { value: "gluteBridge", label: "Glute Bridge" },
  { value: "hipAbductions", label: "Hip Abductions" },
...
//Standardized lifts are multiples of bodyweight
export const standardizedLifts = [
  {
    name: "Bench Press",
    maleStandards: {
      beginner: 0.5,
